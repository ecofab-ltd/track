            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" action="<?php echo base_url();?>Access/updateBrand" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    Brand Name <span style="color: red;">*</span>
                                    <input type="text" class="form-control" id="brand" name="brand" value="<?php echo $brand;?>" placeholder="Brand Name" autocomplete="off" required="required" onblur="isBrandAlreadyExist()">
                                    <input type="hidden" class="form-control" id="brand_id" name="brand_id" value="<?php echo $brand_id;?>" placeholder="Brand Name" autocomplete="off" required="required" onblur="isBrandAlreadyExist()">
                                </div>
                                <div class="col-sm-4 mb-3 mb-sm-0">
