...
foreach($user_brands as $ub){
    array_push($user_brand_array, $ub['brand_id']);
}
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <select class="form-control" id="access_level" disabled="disabled" required="required" onchange="getRequiredFields();">
                                        ...
                                        <option value="2" selected="selected">SD</option>
                                    ...
                                    <select class="form-control" name="brand[]" id="brand" multiple="multiple" data-placeholder="Select Brands">
                                        ...
                                        <?php foreach($brands as $b){ ?>
                                            <option value="<?php echo $b['id'];?>"
                                                    ...
                                                    <?php
                                                    $is_exist = array_search($b['id'], $user_brand_array);
                                                    echo ($is_exist > -1 ? "selected='selected'" : '');
                                                    ?>
