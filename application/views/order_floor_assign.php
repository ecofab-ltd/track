...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Floor Assign</h1>
...
<!--                                    </div>-->
            ...
            <form action="<?php echo base_url();?>Access/orderAssignFloorSave" method="post">
            <!-- Begin Page Content -->
...
<script type="text/javascript">
    ...
    function getOrderList(){
        ...
        if(brands.length > 0){
            ...
            $.ajax({
                async: false,
                url: "<?php echo base_url();?>Access/getOrderFloorAssignFilterList",
                type: "POST",
    ...
    function addNewRow(table_no) {
        ...
        var rowToAdd = $("#"+table_id+" tr:last").clone().find('#floor_qty').val('').end();
//        var rowToAdd = $("#"+table_id+" tr:last").clone();
    ...
    function getPoPlanQty(table_no) {
        ...
        var table_id = "table_"+table_no;
        var order_qty = $("#order_qty_"+table_no).text();

            var calculated_total_sum = 0;

            $("#"+table_id+" .floor_qty").each(function () {
...
//            $("#total_sum_value").html(calculated_total_sum);
            ...
            if(calculated_total_sum > order_qty){
                alert("Order Quantity is Crossed: "+calculated_total_sum+" !");
                $("#"+table_id+" .floor_qty").val('');
            }
