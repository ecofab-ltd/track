...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Line Progress</h1>
<!--        <a href="--><?php //echo base_url()?><!--Access/orderUpload" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-upload fa-sm text-white-50"></i> Upload Order</a>-->
    ...
    <div class="card border-0 shadow-lg">
        <div class="card-body p-0">
            ...
            <form action="<?php echo base_url();?>Access/orderLineOutputSave" method="post">
...
<script type="text/javascript">
    ...
    function getOrderList(){
        ...
        if(operation_date != ''){
            ...
            $.ajax({
                async: false,
                url: "<?php echo base_url();?>Access/getOrderLineProgressFilterList",
                type: "POST",
